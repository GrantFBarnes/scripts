...
"#,
            ...
            Package {
                ...
                desktop_environment: None,
                repository: HashMap::from([
                    (Repository::Arch, vec!["neovim"]),
                    (Repository::Debian, vec!["neovim"]),
                    (Repository::Fedora, vec!["neovim"]),
                    (Repository::Ubuntu, vec!["neovim"]),
                ]),
                flatpak: None,
                snap: None,
                other: None,
            ...
            Package {
                ...
                desktop_environment: None,
                repository: HashMap::from([
                    (Repository::Arch, vec!["vim", "vim-ale"]),
                    (Repository::Debian, vec!["vim", "vim-ale"]),
                    (Repository::Fedora, vec!["vim-enhanced", "vim-ale"]),
                    (Repository::RedHat, vec!["vim-enhanced"]),
                    (Repository::Ubuntu, vec!["vim", "vim-ale"]),
                ]),
                flatpak: None,
                snap: None,
                other: None,
